...
export default function WeatherWidget() {
  ...
  return (
    <div className="flex justify-center items-center h-screen bg-[url('/bg.jpg')] bg-cover">
      ...
      <Card className="w-full max-w-md mx-auto text-center font-serif border-sky-400 border-8 bg-[url('/bg2.jpg')] bg-cover">
        ...
        <CardContent>
          ...
          <form onSubmit={handleSearch} className="flex items-center gap-2 border-sky-900 border-8">
            <Input className="border-sky-400 border-8"
              type="text"
            ...
            />
            <Button type="submit" disabled={isLoading} className="border-sky-400 border-8">
